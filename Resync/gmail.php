...
$inboxhost = "{imap.gmail.com:993/imap/ssl}INBOX";
$senthost = "{imap.gmail.com:993/imap/ssl}[Gmail]/Sent Mail";
$email = "amit.prospus@gmail.com"; //dummy text. I swear i dont have typo here
...
$inboxOverview = imap_fetch_overview($inboxStreamObj,"971:*",FT_UID);
...
$sentOverview = imap_fetch_overview($sentStreamObj,"115:*",FT_UID);
