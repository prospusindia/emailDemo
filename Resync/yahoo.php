...
$inboxhost = "{imap.mail.yahoo.com:993/imap/ssl}Inbox";
$senthost = "{imap.mail.yahoo.com:993/imap/ssl}Sent";
$email = "vwtester2@yahoo.com"; //dummy text. I swear i dont have typo here
...
$inboxOverview = imap_fetch_overview($inboxStreamObj,"21166:*",FT_UID);
...
$sentOverview = imap_fetch_overview($sentStreamObj,"21096:*",FT_UID);
